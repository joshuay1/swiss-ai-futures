window.SWISS_AI_I18N = {
  en: {
    ...
    rounds: [
      ...
      {
        label: "Round 04",
        title: "Review updated material",
        copy: "Return to respond to evolving areas of agreement, disagreement, and policy proposals.",
    ...
    opinion: {
      responses: "responses",
      clusters: [
        { label: "Safeguards", shortLabel: "Safety" },
        { label: "Skills", shortLabel: "Skills" },
  ...
  de: {
    ...
    text: {
      ...
      "Download Atgora, then follow the study onboarding instructions in the app.":
        "Laden Sie Atgora herunter und folgen Sie anschliessend den Anweisungen zur Studie in der App.",
      "App study": "App-Studie",
      ...
      "TA-SWISS is the Swiss Foundation for Technology Assessment. It supports interdisciplinary studies and participatory projects that examine the social, legal, ethical, and political consequences of emerging technologies. Its recommendations are intended to support public debate and decision-making in Switzerland, including for Parliament and the Federal Council.":
        "TA-SWISS ist die Stiftung für Technologiefolgen-Abschätzung. Sie unterstützt interdisziplinäre Studien und partizipative Projekte, die soziale, rechtliche, ethische und politische Folgen neuer Technologien untersuchen. Ihre Empfehlungen sollen die öffentliche Debatte und die Entscheidungsfindung in der Schweiz unterstützen, auch für Parlament und Bundesrat.",
      ...
      "If you stay engaged and complete the main tasks, you may have a chance to be invited, subject to capacity and availability.":
        "Wenn Sie engagiert bleiben und die Hauptaufgaben abschliessen, besteht eine Chance auf eine Einladung, abhängig von Kapazität und Verfügbarkeit.",
      "Workshop": "Workshop",
      "Zurich or Lausanne workshop": "Workshop in Zürich oder Lausanne",
      "Invited participants may attend one physical workshop to review and refine study outputs.":
        "Eingeladene Teilnehmende können an einem Workshop vor Ort teilnehmen, um Studienergebnisse zu prüfen und weiterzuentwickeln.",
      "Eligibility": "Teilnahmevoraussetzungen",
      "Who can join": "Wer teilnehmen kann",
      "You can join the app study if you": "Sie können an der App-Studie teilnehmen, wenn Sie",
      "Are a Swiss resident": "in der Schweiz wohnhaft sind",
      "Are 18 years old or older": "mindestens 18 Jahre alt sind",
      ...
      "Who is running the study": "Wer die Studie durchführt",
      ...
      "The study belongs to the project Transforming Competencies in the Era of Large Language Models (LLMs) and Detecting Future Directions, with a Swiss-affiliated research team working across institutions in Switzerland.":
        "Die Studie gehört zum Projekt Transforming Competencies in the Era of Large Language Models (LLMs) and Detecting Future Directions mit einem in der Schweiz verankerten Forschungsteam, das institutionenübergreifend in der Schweiz arbeitet.",
      "The study belongs to the project": "Die Studie gehört zum Projekt",
      ", with a Swiss-affiliated research team working across institutions in Switzerland.":
      ...
      "Project lead for the broader TA-SWISS study.": "Projektleitung der breiteren TA-SWISS-Studie.",
      "Research team": "Forschungsteam",
      "DRI Survey Design": "DRI-Umfragedesign",
      "External experts": "Externe Expertinnen und Experten",
      "Funder and technology": "Förderung und Technologie",
      "Main funder: Swiss Foundation for Technology Assessment": "Hauptförderer: Stiftung für Technologiefolgen-Abschätzung",
      "Visit TA-SWISS": "TA-SWISS besuchen",
      ...
      "Does the app track my location?": "Erfasst die App meinen Standort?",
      "No. The study does not use app geolocation or background tracking.":
        "Nein. Die Studie nutzt keine App-Geolokalisierung und kein Hintergrundtracking.",
      "Can I withdraw?": "Kann ich zurücktreten?",
    ...
    rounds: [
      ...
      },
      {
        ...
        shotAlt: "Atgora-Beispielbildschirm mit einer Schieberegler-Umfrage"
      },
      {
        label: "Runde 03",
      ...
      {
        label: "Runde 04",
        title: "Aktualisiertes Material prüfen",
        copy: "Kehren Sie zurück, um auf sich entwickelnde Übereinstimmungen, Uneinigkeiten und politische Vorschläge zu reagieren.",
        shotAlt: "Atgora-Beispielbildschirm mit einer Multiple-Choice-Abstimmung zur Einordnung"
      }
    ],
    opinion: {
      responses: "Antworten",
      clusters: [
        { label: "Schutzmassnahmen", shortLabel: "Schutz" },
        { label: "Kompetenzen", shortLabel: "Kompetenzen" },
...
window.SWISS_AI_I18N.fr = {
  ...
  text: {
    ...
    "Download Atgora, then follow the study onboarding instructions in the app.":
      "Téléchargez Atgora, puis suivez les instructions d'entrée dans l'étude dans l'application.",
    "App study": "Étude dans l'app",
    ...
    "TA-SWISS is the Swiss Foundation for Technology Assessment. It supports interdisciplinary studies and participatory projects that examine the social, legal, ethical, and political consequences of emerging technologies. Its recommendations are intended to support public debate and decision-making in Switzerland, including for Parliament and the Federal Council.":
      "TA-SWISS est la Fondation suisse pour l'évaluation des choix technologiques. Elle soutient des études interdisciplinaires et des projets participatifs qui examinent les conséquences sociales, juridiques, éthiques et politiques des technologies émergentes. Ses recommandations visent à soutenir le débat public et la prise de décision en Suisse, notamment au Parlement et au Conseil fédéral.",
    ...
    "If you stay engaged and complete the main tasks, you may have a chance to be invited, subject to capacity and availability.":
      "Si vous restez engagé et complétez les tâches principales, vous pourriez avoir une chance d'être invité, sous réserve des capacités et disponibilités.",
    "Workshop": "Atelier",
    "Zurich or Lausanne workshop": "Atelier à Zurich ou Lausanne",
    "Invited participants may attend one physical workshop to review and refine study outputs.":
      "Les personnes invitées peuvent participer à un atelier en présence pour examiner et affiner les résultats de l'étude.",
    "Eligibility": "Conditions de participation",
    "Who can join": "Qui peut participer",
    "You can join the app study if you": "Vous pouvez participer à l'étude dans l'app si vous",
    "Are a Swiss resident": "résidez en Suisse",
    "Are 18 years old or older": "avez 18 ans ou plus",
    ...
    "Who is running the study": "Qui mène l'étude",
    "Project team": "Équipe du projet",
    "The study belongs to the project Transforming Competencies in the Era of Large Language Models (LLMs) and Detecting Future Directions, with a Swiss-affiliated research team working across institutions in Switzerland.":
      "L'étude fait partie du projet Transforming Competencies in the Era of Large Language Models (LLMs) and Detecting Future Directions, avec une équipe de recherche ancrée en Suisse qui travaille à travers plusieurs institutions en Suisse.",
    "The study belongs to the project": "L'étude fait partie du projet",
    ", with a Swiss-affiliated research team working across institutions in Switzerland.":
    ...
    "Project lead for the broader TA-SWISS study.": "Responsable du projet pour l'étude TA-SWISS plus large.",
    "Research team": "Équipe de recherche",
    "DRI Survey Design": "Conception du sondage DRI",
    "External experts": "Expertes et experts externes",
    "Funder and technology": "Financement et technologie",
    "Main funder: Swiss Foundation for Technology Assessment": "Financeur principal: Fondation suisse pour l'évaluation des choix technologiques",
    "Visit TA-SWISS": "Visiter TA-SWISS",
    ...
    "Does the app track my location?": "L'app suit-elle ma localisation?",
    "No. The study does not use app geolocation or background tracking.": "Non. L'étude n'utilise ni géolocalisation dans l'app ni suivi en arrière-plan.",
  ...
  rounds: [
    ...
    },
    {
      ...
      copy: "Donnez votre avis sur des affirmations concernant la protection des travailleuses et travailleurs, l'innovation, la transparence et la requalification.",
      shotAlt: "Écran d'exemple Atgora montrant un sondage avec curseur"
    },
    {
      label: "Tour 03",
    ...
    {
      label: "Tour 04",
      title: "Examiner le matériel mis à jour",
      copy: "Revenez pour réagir aux zones d'accord, de désaccord et aux propositions politiques qui évoluent.",
      shotAlt: "Écran d'exemple Atgora montrant un sondage d'alignement à choix multiples"
    }
  ],
  opinion: {
    responses: "réponses",
    clusters: [
      { label: "Garanties", shortLabel: "Sécurité" },
      { label: "Compétences", shortLabel: "Compétences" },
...
window.SWISS_AI_I18N.it = {
  ...
  text: {
    ...
    "Download Atgora, then follow the study onboarding instructions in the app.":
      "Scarica Atgora e segui nell'app le istruzioni per entrare nello studio.",
    "App study": "Studio nell'app",
    ...
    "TA-SWISS is the Swiss Foundation for Technology Assessment. It supports interdisciplinary studies and participatory projects that examine the social, legal, ethical, and political consequences of emerging technologies. Its recommendations are intended to support public debate and decision-making in Switzerland, including for Parliament and the Federal Council.":
      "TA-SWISS è la Fondazione svizzera per la valutazione delle scelte tecnologiche. Sostiene studi interdisciplinari e progetti partecipativi che esaminano le conseguenze sociali, giuridiche, etiche e politiche delle tecnologie emergenti. Le sue raccomandazioni mirano a sostenere il dibattito pubblico e i processi decisionali in Svizzera, anche per il Parlamento e il Consiglio federale.",
    ...
    "If you stay engaged and complete the main tasks, you may have a chance to be invited, subject to capacity and availability.":
      "Se resti coinvolto e completi i compiti principali, potresti avere la possibilità di essere invitato, in base alla capacità e alla disponibilità.",
    "Workshop": "Workshop",
    "Zurich or Lausanne workshop": "Workshop a Zurigo o Losanna",
    "Invited participants may attend one physical workshop to review and refine study outputs.":
      "Le persone invitate possono partecipare a un workshop in presenza per rivedere e affinare i risultati dello studio.",
    "Eligibility": "Criteri di partecipazione",
    "Who can join": "Chi può partecipare",
    "You can join the app study if you": "Puoi partecipare allo studio nell'app se",
    "Are a Swiss resident": "risiedi in Svizzera",
    "Are 18 years old or older": "hai almeno 18 anni",
    ...
    "Who is running the study": "Chi conduce lo studio",
    "Project team": "Team del progetto",
    "The study belongs to the project Transforming Competencies in the Era of Large Language Models (LLMs) and Detecting Future Directions, with a Swiss-affiliated research team working across institutions in Switzerland.":
      "Lo studio fa parte del progetto Transforming Competencies in the Era of Large Language Models (LLMs) and Detecting Future Directions, con un team di ricerca radicato in Svizzera che lavora attraverso diverse istituzioni in Svizzera.",
    "The study belongs to the project": "Lo studio fa parte del progetto",
    ", with a Swiss-affiliated research team working across institutions in Switzerland.":
    ...
    "Project lead for the broader TA-SWISS study.": "Responsabile del progetto per lo studio TA-SWISS più ampio.",
    "Research team": "Team di ricerca",
    "DRI Survey Design": "Progettazione del sondaggio DRI",
    "External experts": "Esperte ed esperti esterni",
    "Funder and technology": "Finanziamento e tecnologia",
    "Main funder: Swiss Foundation for Technology Assessment": "Finanziatore principale: Fondazione svizzera per la valutazione delle scelte tecnologiche",
    "Visit TA-SWISS": "Visita TA-SWISS",
    ...
    "Does the app track my location?": "L'app traccia la mia posizione?",
    "No. The study does not use app geolocation or background tracking.": "No. Lo studio non usa geolocalizzazione dell'app né tracciamento in background.",
  ...
  rounds: [
    ...
    },
    {
      ...
      shotAlt: "Schermata di esempio di Atgora con un sondaggio a cursore"
    },
    {
      label: "Turno 03",
    ...
    {
      label: "Turno 04",
      title: "Rivedere materiale aggiornato",
      copy: "Torna per reagire ad aree emergenti di accordo, disaccordo e proposte politiche.",
      shotAlt: "Schermata di esempio di Atgora con un sondaggio di allineamento a scelta multipla"
    }
  ],
  opinion: {
    responses: "risposte",
    clusters: [
      { label: "Tutele", shortLabel: "Tutele" },
      { label: "Competenze", shortLabel: "Competenze" },
