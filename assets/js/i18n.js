(() => {
  ...
  const copy = {
    en: {
      ...
      zurichVenueShort: "ETH Zürich HG — English workshop: room F 26.3; German workshop: room F 26.5.",
      lausanneVenueShort: "Université de Lausanne, Internef building — French workshop: room 231; English workshop: room 232.",
      ...
      attendance: [
        ["Zürich", "Tuesday, August 11, 5:30-7:30 pm. ETH Zürich HG — English workshop: room F 26.3; German workshop: room F 26.5."],
        ["Lausanne", "Wednesday, August 12, 5:30-7:30 pm. Université de Lausanne, Internef building — French workshop: room 231; English workshop: room 232."],
      ...
      qa: [
        ...
        ["What happens after I sign up?", "<p>You will receive confirmation after signing up, plus any final workshop instructions by email before the event.</p>"],
        ["Can I download flyers?", '<p>Yes. You can download public flyer PDFs for the Swiss AI Futures Citizen Workshops.</p><p class="qa-download-links"><a href="output/swiss-ai-futures-flyer-pdfs.zip" download>Flyer PDFs</a></p><p>The package includes English, German, and French flyer PDFs.</p>'],
    ...
    de: {
      ...
      zurichVenueShort: "ETH Zürich HG — Workshop auf Englisch: Raum F 26.3; Workshop auf Deutsch: Raum F 26.5.",
      lausanneVenueShort: "Université de Lausanne, Gebäude Internef — Workshop auf Französisch: Raum 231; Workshop auf Englisch: Raum 232.",
      ...
      attendance: [
        ["Zürich", "Dienstag, 11. August, 17:30-19:30. ETH Zürich HG — Workshop auf Englisch: Raum F 26.3; Workshop auf Deutsch: Raum F 26.5."],
        ["Lausanne", "Mittwoch, 12. August, 17:30-19:30. Université de Lausanne, Gebäude Internef — Workshop auf Französisch: Raum 231; Workshop auf Englisch: Raum 232."],
      ...
      qa: [
        ...
        ["Was passiert nach meiner Anmeldung?", "<p>Nach der Anmeldung erhalten Sie eine Bestätigung sowie vor der Veranstaltung allfällige letzte Workshop-Informationen per E-Mail.</p>"],
        ["Kann ich Flyer herunterladen?", '<p>Ja. Sie können öffentliche Flyer-PDFs für die Swiss AI Futures Bürgerworkshops herunterladen.</p><p class="qa-download-links"><a href="output/swiss-ai-futures-flyer-pdfs.zip" download>Flyer-PDFs</a></p><p>Das Paket enthält englische, deutsche und französische Flyer-PDFs.</p>'],
    ...
    fr: {
      ...
      zurichVenueShort: "ETH Zürich HG — atelier en anglais : salle F 26.3 ; atelier en allemand : salle F 26.5.",
      lausanneVenueShort: "Université de Lausanne, bâtiment Internef — atelier en français : salle 231 ; atelier en anglais : salle 232.",
      zurichTime: "17:30-19:30",
      lausanneTime: "17:30-19:30",
      ...
      attendance: [
        ["Zurich", "Mardi 11 août, 17:30-19:30. ETH Zürich HG — atelier en anglais : salle F 26.3 ; atelier en allemand : salle F 26.5."],
        ["Lausanne", "Mercredi 12 août, 17:30-19:30. Université de Lausanne, bâtiment Internef — atelier en français : salle 231 ; atelier en anglais : salle 232."],
      ...
      qa: [
        ...
        ["Que se passe-t-il après mon inscription?", "<p>Vous recevrez une confirmation après votre inscription, ainsi que les éventuelles dernières informations sur l'atelier par e-mail avant l'événement.</p>"],
        ["Puis-je télécharger les flyers?", '<p>Oui. Vous pouvez télécharger des flyers PDF publics pour les ateliers citoyens Swiss AI Futures.</p><p class="qa-download-links"><a href="output/swiss-ai-futures-flyer-pdfs.zip" download>Flyers PDF</a></p><p>Le paquet inclut les flyers PDF en anglais, allemand et français.</p>'],
