...
| **How workplace training should be organised** | 82% supported training for workers’ current jobs. In the English-speaking Zurich workshop, 25 of 28 supported help for people who may become unemployed because of AI; one participant later said that “skills to prepare for unemployment” were still missing from the final output. A single certificate for all workers received only 33% support. | Employer-based training for people in work, plus publicly accessible retraining, guidance, and financial support for people facing job loss or already unemployed. Include small firms, older workers, and occupations with fewer digital resources. |
